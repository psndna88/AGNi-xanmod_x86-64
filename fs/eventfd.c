...
static __u64 eventfd_signal_mask_compat(struct eventfd_ctx *ctx, __u64 n, __poll_t mask)
{
	unsigned long flags;
 ...
 */
__u64 eventfd_signal_compat(struct eventfd_ctx *ctx, __u64 n)
{
	return eventfd_signal_mask_compat(ctx, n, 0);
}
